...
const contractAddress = '0x45EA7F9F9d3B2943B127d5ad5401ECdb1bF0713d';
...
function showDoc() {
  ...
  try {
    web3.personal.unlockAccount(account, document.getElementById('admin_pass').value);

    async function getDoc(){
      let get_temp=smartContract.getDocStruct(doc_num, { from: account, gas: 2000000 });
      return get_temp;
    }
